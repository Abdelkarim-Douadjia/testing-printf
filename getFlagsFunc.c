 ...
 * the integer pointer i, usign predefined flags and characters.
 * It updates i to the last processed inedx and returns
 * the flags as an integer.
 *
 * @format: the formatted string in which to print the arguments
 * @i: take a parameter
 *
 * Return: calculated falgs are then returned as an integer.
*/
