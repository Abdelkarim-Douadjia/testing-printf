 ...
 * considering special cass like '%', and takes parameters
 * for flags, width, precision, and size.
 *
 * @frmt: the formatted string in which to print arguments.
...
*/
int handlePrint(const char *frmt, int *ind, va_list list,
char buffer[], int flags, int width, int precision, int size)
{
	format_t formatTypes[] = {
		...
		{'o', printfOctal},
		{'x', printfHexadecimal},
		{'X', printfHexaUpper}, {'p', printfPointer},
		{'S', printfUnPrintable}, {'r', printfReverse},
		{'R', printfRot13String}, {'\0', NULL}
	};
	int unLen = 0, i, printedCh = -1;
